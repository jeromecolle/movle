SELECT title_basics.primaryTitle, title_basics.startYear, title_basics.runtimeMinutes, title_basics.genres, ratings.averageRating, group_concat(names.primaryName)
FROM title_basics
